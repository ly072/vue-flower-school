...
<!-- 		<el-card> -->
			<div id="myChartChina2" :style="{width: '100%', height: '400px'}"></div>
<!-- 		</el-card> -->
...
<script>
	...
	export default {
	  ...
	  methods: {
		  drawLine2(){
			  var myChartContainer = document.getElementById('myChartChina2');
			  ...
			  // $.get('echarts/map/json/china.json', function (usaJson) {
			      myChart.hideLoading();
